                                ...
                                <div className="row">
                                    ...
                                    <div className="col-lg-12">
                                        <div className="form-group">
                                         ...
                                         <span class="" ><button type = "button" onClick={subtitleAdded}>{<AiOutlinePlusCircle/>}</button></span> 
                                            </div>  
 ...
 */}
                                    ...
                                    <div className="col-lg-12 my-2">
                                        <div className="form-group">
                                           <button className="btn bg-green-500 w-30 mx-5" type="submit">Add</button>
            ...
            <table class="table borderless">
                    ...
                    {usersList?.map((item)=>(<tr class="border-2x solid black">
                      ...
                      <td 
                        ...
                        class="flex  flex-col align-middle justify-center items-center mt-3"> <div >
